const translation = {
  ...
  welcome: 'Welcome to Lab[IA], please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Lab[IA] Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join',
  joinTipStart: 'Invite you join',
  joinTipEnd: 'team on Lab[IA]',
  invalid: 'The link has expired',
  explore: 'Explore Lab[IA]',
