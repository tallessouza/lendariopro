const translation = {
  ...
  welcome: 'Willkommen bei Lab[IA], bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Lab[IA] Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Lab[IA] beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Lab[IA] erkunden',
