const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Oder probieren Sie die Cloud-Version von Lab[IA] mit kostenlosem Angebot aus',
  },
  overview: {
    title: 'Übersicht',
    appInfo: {
      ...
      embedded: {
        ...
        chromePlugin: 'Installieren Sie die Lab[IA] Chatbot Chrome-Erweiterung',
        copied: 'Kopiert',
        copy: 'Kopieren',
      },
      qrcode: {
