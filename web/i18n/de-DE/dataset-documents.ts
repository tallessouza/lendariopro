const translation = {
  list: {
    title: 'Dokumente',
    desc: 'Alle Dateien des Wissens werden hier angezeigt, und das gesamte Wissen kann mit Lab[IA]-Zitaten verknüpft oder über das Chat-Plugin indiziert werden.',
    ...
    empty: {
      ...
      sync: {
        tip: 'Lab[IA] wird periodisch Dateien von Ihrem Notion herunterladen und die Verarbeitung abschließen.',
      },
    },
    delete: {
