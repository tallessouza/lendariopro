const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Hoặc thử phiên bản điện toán đám mây của Lab[IA] với báo giá miễn phí',
  },
  overview: {
    title: 'Tổng quan',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Giúp khách truy cập hiểu được dữ liệu mà ứng dụng thu thập, xem <privacyPolicyLink>Chính sách bảo mật</privacyPolicyLink> của Lab[IA].',
      ...
      embedded: {
        ...
        chromePlugin: 'Cài đặt Tiện ích Mở rộng Lab[IA] Chatbot cho Chrome',
        copied: 'Đã sao chép',
        copy: 'Sao chép',
      },
      qrcode: {
