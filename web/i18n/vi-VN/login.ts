const translation = {
  ...
  welcome: 'Chào mừng bạn đến với Lab[IA], vui lòng đăng nhập để tiếp tục.',
  email: 'Địa chỉ Email',
  ...
  license: {
    tip: 'Trước khi bắt đầu Phiên bản Cộng đồng của Lab[IA], hãy đọc',
    link: 'Giấy phép mã nguồn mở trên GitHub',
  },
  join: 'Tham gia',
  joinTipStart: 'Mời bạn tham gia',
  joinTipEnd: 'đội tại Lab[IA]',
  invalid: 'Liên kết đã hết hạn',
  explore: 'Khám phá Lab[IA]',
