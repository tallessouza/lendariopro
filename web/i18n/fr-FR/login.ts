const translation = {
  ...
  welcome: 'Bienvenue sur Lab[IA], veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Lab[IA] Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Lab[IA]',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Lab[IA]',
