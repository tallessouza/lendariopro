const translation = {
  ...
  welcome: 'Witaj w Lab[IA], zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Lab[IA], przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Lab[IA]',
  invalid: 'Link wygasł',
  explore: 'Odkryj Lab[IA]',
