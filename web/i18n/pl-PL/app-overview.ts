const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Lub wypróbuj wersję chmurową Lab[IA] z darmowym limitem',
  },
  overview: {
    title: 'Przegląd',
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip:
            'Pomaga odwiedzającym zrozumieć, jakie dane zbiera aplikacja, zobacz <privacyPolicyLink>Politykę prywatności Lab[IA]</privacyPolicyLink>.',
      ...
      embedded: {
        ...
        chromePlugin: 'Zainstaluj rozszerzenie Chrome Lab[IA] Chatbot',
        copied: 'Skopiowane',
        copy: 'Kopiuj',
      },
      qrcode: {
