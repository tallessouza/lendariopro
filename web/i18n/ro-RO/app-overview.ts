const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Lab[IA] cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Lab[IA].',
        },
      },
      embedded: {
        entry: 'Încorporat',
        ...
        chromePlugin: 'Instalați extensia Chrome Lab[IA] Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
      ...
      customize: {
        ...
        way1: {
          ...
          step1Operation: 'Lab[IA]-WebClient',
