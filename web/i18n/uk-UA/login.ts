const translation = {
  ...
  welcome: 'Ласкаво просимо до Lab[IA], будь ласка, увійдіть, щоб продовжити.',
  ...
  license: {
    tip: 'Перед запуском Lab[IA] Community Edition ознайомтеся з ліцензією з відкритим кодом на GitHub',
    link: 'Ліцензія з відкритим кодом',
  },
  join: 'Приєднуйтесь',
  joinTipStart: 'Запрошуємо вас приєднатися',
  joinTipEnd: 'команда Lab[IA]',
  invalid: 'Посилання застаріло',
  explore: 'Досліджуйте Lab[IA]',
