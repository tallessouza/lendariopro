        ...
        <div className='flex items-center justify-between'>
          <div className='flex items-center '>
            <div className='mr-3 p-1 bg-gray-200 group-hover:bg-white rounded-lg'>
              <Settings04 className='w-4 h-4 text-gray-600 group-hover:text-[#d7b97f]' />
            </div>
            <div className='leading-5 text-sm font-medium text-gray-900 group-hover:text-[#d7b97f]'>{t('appDebug.agent.setting.name')}</div>
          </div>
          <ArrowUpRight className='w-4 h-4 text-gray-500 group-hover:text-[#d7b97f]' />
        </div>
